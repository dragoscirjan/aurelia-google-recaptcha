...
System.register(["aurelia-framework", "./recaptcha-v2"], function (_export, _context) {
  ...
  var bindable, customElement, RecaptchaV2, _dec, _class, _class2, _descriptor, _descriptor2, _temp, RecaptchaV2Invisible;
  ...
  return {
    ...
    execute: function () {
      _export("RecaptchaV2Invisible", RecaptchaV2Invisible = (_dec = customElement('recaptcha-v2-invisible'), _dec(_class = (_class2 = (_temp = function (_RecaptchaV) {
      ...
      }(RecaptchaV2), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "badge", [bindable], {
        configurable: true,
        enumerable: true,
        writable: true,
