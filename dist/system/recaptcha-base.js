...
System.register(["aurelia-framework", "aurelia-event-aggregator", "nanoid"], function (_export, _context) {
  "use strict";

  var bindable, bindingMode, inject, noView, EventAggregator, nanoid, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _temp, getHash, GR, RecaptchaBase;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RecaptchaBase", RecaptchaBase = (_dec = noView(), _dec2 = inject(Element, EventAggregator), _dec3 = bindable({
