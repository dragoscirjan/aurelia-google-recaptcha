...
System.register(['aurelia-framework', 'aurelia-event-aggregator', 'nanoid'], function(_export, _context) {
  ...
  return {
    ...
    execute: function() {
      ...
      _export(
        'RecaptchaBase',
        (RecaptchaBase = ((_dec = noView()),
        (_dec2 = inject(Element, EventAggregator)),
        (_dec3 = bindable({
            ...
            _dec2(
              (_class = ((_class2 = ((_temp = _class3 = (function() {
                ...
                _proto.unloadScript = function unloadScript(id) {
                  if (
                    !document.querySelectorAll('[data-script=' + id + ']').length &&
              ...
              _temp)),
              ((_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'auto', [bindable], {
                configurable: true,
                enumerable: true,
                writable: true,
